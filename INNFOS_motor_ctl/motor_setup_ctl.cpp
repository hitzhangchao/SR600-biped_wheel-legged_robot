...
/***************************************************
 * Function: set actuator homing point and limitation
 * ID    MAX    MIN
 * 1      0     -17
 * 2      17     0
 * 5      0     -9.5
...
void setActuatorLimitation()
{
    ...
    pController->setActuatorAttribute(idArray.at(0),Actuator::POS_OFFSET,0);
    ...
    pController->setActuatorAttribute(idArray.at(1),Actuator::POS_OFFSET,0);
    ...
    pController->setActuatorAttribute(idArray.at(2),Actuator::POS_OFFSET,0);
    ...
    pController->setActuatorAttribute(idArray.at(3),Actuator::POS_OFFSET,0);
}

/***************************************************
 * Fuction: set target position
 * Input: value of target position
****************************************************/
void setTargetPosition(double value_1,double value_2,double value_3,double value_4)
{
    ...
    controllerInst->activateActuatorMode(idArray,Actuator::Mode_Profile_Pos);    //active Profile Positiion Mode
    controllerInst->setPosition(idArray.at(0), value_1);                          //set position value
    controllerInst->setPosition(idArray.at(1), value_2);
    controllerInst->setPosition(idArray.at(2), value_3);
    controllerInst->setPosition(idArray.at(3), value_4);
...
int main(int argc, char *argv[])
{
    ...
    while (!bExit)
    {
        ...
        else if(command=='g'||command =='h'||command=='l'||command=='r')
        {
