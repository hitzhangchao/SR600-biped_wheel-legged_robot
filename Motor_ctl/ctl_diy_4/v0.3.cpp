 ...
 * Input: command: r:get position,l:launch actuator,s:shut down actuator
****************************************************/
void commandOperation(char command)
{
    ...
    case 'l':
        ...
        cout << "launch actuator completed."<<endl;
        break;
    case 's':
        controllerInst->closeAllActuators();
        cout << "close actuator completed."<<endl;
        break;
    default:
        break;
    }
...
int main(int argc, char *argv[])
{
    ...
    thread inputThread_2(keyboardInput_2);                                  //declar another inputThread
